...
class StringFormatterTest(unittest.TestCase):
    ...
    def test_format_elements_snakecase_internal_index(self):
        ...
        package_cheat_sheet.StringFormatter.format_elements_to_snakecase(test_list, internal_index=0)
    ...
    def test_format_string_to_snakecase_abbreviation(self):
        ...
        self.assertEqual('aaa_aaa', package_cheat_sheet.StringFormatter.format_to_snakecase('AAA-AAA'))

    def test_format_string_to_snakecase_camelcase(self):
        self.assertEqual('camel_case', package_cheat_sheet.StringFormatter.format_to_snakecase('camelCase'))

    def test_format_string_to_snakecase_leading_number(self):
        self.assertEqual('1_number', package_cheat_sheet.StringFormatter.format_to_snakecase('1 number'))
    ...
    def test_format_string_to_snakecase_unicode(self):
        self.assertEqual('a_a_e_o_u', package_cheat_sheet.StringFormatter.format_to_snakecase(u'å ä ß é ö ü'))

    def test_format_string_to_snakecase_uppercase(self):
        self.assertEqual('uppercase', package_cheat_sheet.StringFormatter.format_to_snakecase('UPPERCASE'))
        self.assertEqual('upper_case', package_cheat_sheet.StringFormatter.format_to_snakecase('UPPER CASE'))
